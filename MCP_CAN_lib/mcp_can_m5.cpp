...
*********************************************************************************************************/
void MCP_CAN_M5::mcp2515_reset(void)                                      
{
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::mcp2515_readRegister(const INT8U address)
{
    INT8U ret;
...
*********************************************************************************************************/
void MCP_CAN_M5::mcp2515_readRegisterS(const INT8U address, INT8U values[], const INT8U n)
{
    INT8U i;
    SPI.beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
*********************************************************************************************************/
void MCP_CAN_M5::mcp2515_setRegister(const INT8U address, const INT8U value)
{
    SPI.beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
*********************************************************************************************************/
void MCP_CAN_M5::mcp2515_setRegisterS(const INT8U address, const INT8U values[], const INT8U n)
{
    INT8U i;
    SPI.beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
*********************************************************************************************************/
void MCP_CAN_M5::mcp2515_modifyRegister(const INT8U address, const INT8U mask, const INT8U data)
{
    SPI.beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::mcp2515_readStatus(void)
{
    INT8U i;
    SPI.beginTransaction(SPISettings(10000000, MSBFIRST, SPI_MODE0));
    MCP2515_SELECT();
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::setMode(const INT8U opMode)
{
    mcpMode = opMode;
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::mcp2515_setCANCTRL_Mode(const INT8U newmode)
{
    INT8U i;
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::mcp2515_configRate(const INT8U canSpeed, const INT8U canClock)
{
...
*********************************************************************************************************/
void MCP_CAN_M5::mcp2515_initCANBuffers(void)
{
    INT8U i, a1, a2, a3;
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::mcp2515_init(const INT8U canIDMode, const INT8U canSpeed, const INT8U canClock)
{
...
*********************************************************************************************************/
void MCP_CAN_M5::mcp2515_write_id( const INT8U mcp_addr, const INT8U ext, const INT32U id )
{
    uint16_t canid;
    INT8U tbufdata[4];
...
*********************************************************************************************************/
void MCP_CAN_M5::mcp2515_write_mf( const INT8U mcp_addr, const INT8U ext, const INT32U id )
{
    uint16_t canid;
    INT8U tbufdata[4];
...
*********************************************************************************************************/
void MCP_CAN_M5::mcp2515_read_id( const INT8U mcp_addr, INT8U* ext, INT32U* id )
{
    INT8U tbufdata[4];
...
*********************************************************************************************************/
void MCP_CAN_M5::mcp2515_write_canMsg( const INT8U buffer_sidh_addr)
{
    INT8U mcp_addr;
...
*********************************************************************************************************/
void MCP_CAN_M5::mcp2515_read_canMsg( const INT8U buffer_sidh_addr)        /* read can msg                 */
{
    INT8U mcp_addr, ctrl;
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::mcp2515_getNextFreeTXBuf(INT8U *txbuf_n)                 /* get Next free txbuf          */
{
    INT8U res, i, ctrlval;
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::begin(INT8U idmodeset, INT8U speedset, INT8U clockset)
{
    INT8U res;
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::init_Mask(INT8U num, INT8U ext, INT32U ulData)
{
...
** Descriptions:            Public function to set mask(s).
*********************************************************************************************************/
INT8U MCP_CAN_M5::init_Mask(INT8U num, INT32U ulData)
{
    INT8U res = MCP2515_OK;
    INT8U ext = 0;
#if DEBUG_MODE
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::init_Filt(INT8U num, INT8U ext, INT32U ulData)
{
    INT8U res = MCP2515_OK;
#if DEBUG_MODE
...
** Descriptions:            Public function to set filter(s).
*********************************************************************************************************/
INT8U MCP_CAN_M5::init_Filt(INT8U num, INT32U ulData)
{
    INT8U res = MCP2515_OK;
    INT8U ext = 0;
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::setMsg(INT32U id, INT8U rtr, INT8U ext, INT8U len, INT8U *pData)
{
    int i = 0;
    m_nID     = id;
    m_nRtr    = rtr;
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::sendMsgBuf(INT32U id, INT8U ext, INT8U len, INT8U *buf)
{
    INT8U res;
...
** Descriptions:            Send message to transmitt buffer
*********************************************************************************************************/
INT8U MCP_CAN_M5::sendMsgBuf(INT32U id, INT8U len, INT8U *buf)
{
    INT8U ext = 0, rtr = 0;
    INT8U res;
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::readMsgBuf(INT32U *id, INT8U *ext, INT8U *len, INT8U buf[])
{
...
** Descriptions:            Public function, Reads message from receive buffer.
*********************************************************************************************************/
INT8U MCP_CAN_M5::readMsgBuf(INT32U *id, INT8U *len, INT8U buf[])
{
    if(readMsg() == CAN_NOMSG)
	return CAN_NOMSG;
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::checkReceive(void)
{
    INT8U res;
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::checkError(void)
{
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::getError(void)
{
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::errorCountRX(void)                             
{
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::errorCountTX(void)                             
{
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::enOneShotTX(void)                             
{
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::disOneShotTX(void)                             
{
...
*********************************************************************************************************/
INT8U MCP_CAN_M5::setGPO(INT8U data)
{
